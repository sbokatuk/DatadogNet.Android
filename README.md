...
<PackageReference Include="DatadogNet.Logs.Android" Version="3.12.1.2" />
```
...
```bash
./.github/scripts/run-emulator-tests.sh 3.12.1.2 net9.0-android35.0
```
...
Tag it. `v3.12.1.2` builds, tests, publishes all thirteen packages to nuget.org via trusted
